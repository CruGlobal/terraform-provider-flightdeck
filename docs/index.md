...
description: |-
  The flightdeck provider manages a Flightdeck https://github.com/CruGlobal/flightdeck workspace's project configuration — projects, workflow states, labels, members, ingestion tokens, error alert rules and outbound webhooks — through its REST API, so that configuration can live in Terraform alongside the rest of an application's infrastructure.
  Authentication
